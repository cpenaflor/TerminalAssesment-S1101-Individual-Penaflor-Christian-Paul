...
public class Main {
	...
	public static void main(String[] args) {
		...
		String employeeNoToSearch = strScanner.nextLine();
		
		Employee _employee = new Employee();
		try {
			_employee.ReadEmployee(employeeNoToSearch);
		} catch ( Exception e) {
			e.printStackTrace();
		}
		...
		System.out.println("Employee Address:" + _employee.GetEmployeeAddress());
		System.out.println("Employee Hourly Rate:" + _employee.GetHourlyRate());
		
		Scanner fltScanner = new Scanner(System.in);
		
		System.out.print("Enter Total Hour: ");
		float totalHour = fltScanner.nextFloat();
		_employee.SetTotalhour(totalHour);
		
		float hourlyRate = _employee.GetHourlyRate();
		float averageHour = _employee.ComputeAverageHour();

		System.out.println("-----------------------------------------");
		System.out.println("-----MOTORPH PAYSLIP----- by Christian Paul Penaflor");
		System.out.println("Employee Total Hour: " + averageHour);
		System.out.println("Employee Hourly Rate: " + hourlyRate);
		System.out.println("Total Salary: " + averageHour * hourlyRate);
		System.out.println("-----------------------------------------");
		System.out.println("Deductions");
		
//PAGIBIG 
        double salary = hourlyRate * averageHour;
